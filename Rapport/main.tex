...
\begin{table}[H]
		...
		\textbf{n} &
		  ...
		  \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Temps d'exécution\\ code interprété\end{tabular}}} &
		  \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Temps d'exécution\\ code compilé\end{tabular}}} &
...
Ainsi, les instructions \verb|inc| mais surtout \verb|dec| ont bien été insérées dans le code pour modifier le nombre de références 
