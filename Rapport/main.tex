...
La mémoire d’un programme Wasm est linear memory.\cite{haas_bringing_2017}
Linear memory est un tampon continu d'octets non signés  que Javascript et Wasm peuvent lire et modifier de manière synchrone. 
