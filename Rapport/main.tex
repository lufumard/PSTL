...
\begin{table}[H]
	\begin{tabular}{|c|r|}
		\hline
		\textbf{Tâche} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Temps \\ (en heures-homme)\end{tabular}}} \\ \hline
		Gestion du niveau                                                                             & 4           \\ \hline
		\begin{tabular}[c]{@{}c@{}}Gestion de l'affichage\\ (niveau, PAC-MAN \& sprites)\end{tabular} & 5           \\ \hline
		\begin{tabular}[c]{@{}c@{}}Gestion du déplacement de\\ PAC-MAN\end{tabular}                   & 3           \\ \hline
		\begin{tabular}[c]{@{}c@{}}Algorithme de déplacement\\ des fantômes\end{tabular}              & 8           \\ \hline
		\begin{tabular}[c]{@{}c@{}}Gestion des différents modes\\ du jeu\end{tabular}                 & 3           \\ \hline
		\begin{tabular}[c]{@{}c@{}}Algorithme de sélection \\ de cible des fantômes\end{tabular}      & 9           \\ \hline
		\begin{tabular}[c]{@{}c@{}}Affinage des constantes du\\ jeu et du moteur de jeu\end{tabular}  & 2           \\ \hline
		\multicolumn{1}{|l|}{\textbf{Total}}                                                          & \textbf{34} \\ \hline
	\end{tabular}
