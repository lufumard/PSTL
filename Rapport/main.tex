...
La pile est implémentée par un énumérateur \verb|Ctxt| contenant les champs pour le nom de la variable, la valeur de la variable, 
ainsi que la suite de la pile. On agrandi cette pile en l'englobant dans un nouvel énumérateur \verb|Ctxt| contenant les champs 
...
Ce tas \verb|Heap| est une structure contenant une table de hashage d'un entier vers un \verb|Value|.
