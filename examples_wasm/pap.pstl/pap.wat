...
(func $fun_mainpapcall (export "mainpapcall")(param $var_f i32) (result i32)
(local $__intern_var i32)
(local $var_r i32)
(local $var_m i32)
...
(func $fun_mainpap (export "mainpap")(result i32)
(local $var_r i32)
(local $var_f i32)
(local $var_n i32)
(local $var_m i32)
...
(func $fun_mainpap2 (export "mainpap2")(result i32)
(local $var_r i32)
(local $var_n i32)
(local $var_m i32)
(local $__intern_var i32)
